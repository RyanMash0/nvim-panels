...
function M.highlight()
	...
	local dir_hl = vim.api.nvim_get_hl_id_by_name('PanelsTreeDir')
	local bar_hl = vim.api.nvim_get_hl_id_by_name('PanelsTreeBar')
	local plain_hl = vim.api.nvim_get_hl_id_by_name('PanelsTreePlain')
	local header_hl = vim.api.nvim_get_hl_id_by_name('PanelsTreeHeader')
	local target_hl = vim.api.nvim_get_hl_id_by_name('PanelsTreeTarget')
	local source_hl = vim.api.nvim_get_hl_id_by_name('PanelsTreeSource')
