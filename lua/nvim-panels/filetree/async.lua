...
---
---@generic T
---@return nvim-panels.filetree.log<T>
function M.new_log()
	local data = {}
	return {
...
---
---@generic T
---@return nvim-panels.filetree.verifier<T>
...
---
---@param co thread
---@param err_log nvim-panels.filetree.log<nvim-panels.filetree.err_log_entry>
---@param path_log? nvim-panels.filetree.log<nvim-panels.filetree.path_log_entry>
---@return nvim-panels.filetree.process_counter
...
---
---@param path string
---@param path_verifier? nvim-panels.filetree.verifier<string>
---@return string
...
---@param err_log nvim-panels.filetree.log<nvim-panels.filetree.err_log_entry>
---@return nvim-panels.filetree.path_obj[][], nvim-panels.filetree.path_obj[]
...
---
---@param dirs nvim-panels.filetree.path_obj[]
---@param err_log nvim-panels.filetree.log<nvim-panels.filetree.err_log_entry>
---@param path_log nvim-panels.filetree.log<nvim-panels.filetree.path_log_entry>
---@param log_new_paths boolean
---@return nvim-panels.filetree.err_log_entry[], nvim-panels.filetree.path_log_entry[]
...
---
---@param files nvim-panels.filetree.path_obj[]
---@param err_log nvim-panels.filetree.log<nvim-panels.filetree.err_log_entry>
---@param path_log nvim-panels.filetree.log<nvim-panels.filetree.path_log_entry>
---@param log_new_paths boolean
---@return nvim-panels.filetree.err_log_entry[], nvim-panels.filetree.path_log_entry[]
...
---
---@param items nvim-panels.filetree.path_obj[]
---@return nvim-panels.filetree.err_log_entry[], nvim-panels.filetree.path_log_entry[]
