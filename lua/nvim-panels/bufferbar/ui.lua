...
function M.highlight()
	...
	local hl_group = vim.api.nvim_get_hl_id_by_name('PanelsBufferBarCurrent')
	local yank_hl_group = vim.api.nvim_get_hl_id_by_name('PanelsBufferBarYank')
	local close_hl_group = vim.api.nvim_get_hl_id_by_name('PanelsBufferBarClose')
	local modified_hl_group = vim.api.nvim_get_hl_id_by_name('PanelsBufferBarModified')
