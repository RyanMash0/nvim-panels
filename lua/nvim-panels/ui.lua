...
---
---@param tree nvim-panels.winlayout.branch | nvim-panels.winlayout.leaf
---@return nvim-panels.winlayout.leaf
local function leftmost_leaf(tree)
	local leaf = tree
	while leaf[1] ~= constants.winlayout_type.LEAF do
		leaf = leaf[2][1]
	end
	---@cast leaf nvim-panels.winlayout.leaf
	return leaf
end

---
---@param forest (nvim-panels.winlayout.branch | nvim-panels.winlayout.leaf)[]
---@param parents nvim-panels.winlayout.parent[]
---@param depth integer
...
local function parse_layout()
	...
	---@cast win_tree nvim-panels.winlayout.branch | nvim-panels.winlayout.leaf
...
---
---@param win nvim-panels.editor_win
---@return nvim-panels.editor_win
...
---
---@param mod_constants nvim-panels.module.constants
---@return nvim-panels.buf_config
