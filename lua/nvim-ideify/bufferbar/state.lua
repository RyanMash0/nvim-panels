...
---@return nvim-ideify.bufferbar.do_buf_iterator, nil, integer
function M.buf_iterator(start_pos)
	return buf_iterator, nil, (start_pos and start_pos - 1) or 0
end

---
---@return nvim-ideify.do_generic_iterator, table<nvim-ideify.buf_id, nvim-ideify.bufferbar.entry>, nvim-ideify.buf_id?
...
---
---@param buf? nvim-ideify.buf_id
---@return nvim-ideify.bufferbar.entry?
